...
if %errorlevel% equ 3 goto estado
if %errorlevel% equ 2 goto reparar
if %errorlevel% equ 1 goto explorar
goto menu
...
:evento_piratas
echo Senales hostiles: piratas espaciales.
...
rem ====== Helpers (Al final para evitar ejecucion accidental) ======
:log
